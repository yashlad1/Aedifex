...
| FR-034 | The system shall accept only formats a source is permitted to yield. | Implemented | `test_format_outside_the_source_allowlist_is_rejected` |
| FR-035 | The system shall neutralise untrusted filenames and never derive storage paths from them. | Implemented | `TestSafeFilename` |
...
| ID | Requirement | Status | Evidence |
| --- | --- | --- | --- |
| FR-070 | The system shall download publicly available construction procurement documents. | Planned | — |
| FR-071 | The system shall rate-limit, retry with backoff, and bound concurrency per source. | Planned | — |
